...
if (isset($_GET['return'])) {
    ...
    mysqli_query($conn, "DELETE FROM reading_progress WHERE user_id='$user_id' AND product_id='$book_id'") or die('query failed');
...
<div class="library-container">
    ...
    <div class="library-grid">
        ...
        <div class="library-book">
            ...
            <a href="my_library.php?return=<?php echo $book['id']; ?>" class="return-btn" onclick="return confirm('Are you sure you want to return this book?');">
    ...
    ?>
    <div class="no-books">
        <p>You haven't purchased any books yet. <a href="shop.php">Browse our collection</a> to get started!</p>
    </div>
    <?php
    }
    ?>
