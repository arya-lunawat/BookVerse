...
<section class="admin_dashboard">
  ...
  <div class="admin_box_container">
    ...
    <div class="admin_box">
      <?php
        $select_books_sold=mysqli_query($conn,"SELECT COUNT(*) as total FROM `purchased_books`") or die('query failed');
        $books_sold = mysqli_fetch_assoc($select_books_sold)['total'];
      ?>
      <h3><?php echo $books_sold; ?></h3>
      <p>Books Sold</p>
    </div>
